...
const customComponent = {
	...
	'.ybg-radial-golden': {
		backgroundImage:
			'linear-gradient(70deg,#94783e -4.34%,#f3eda6 20.27%,#f8fae5 34.61%,#fee7c6 47.88%,#d5be88 84.8%,#f8fae5 95.7%,#d5be88 107.63%)',
	...
	'.ybg-radial-dark': {
		backgroundImage:
			'linear-gradient(135deg, #ABFFFD 2.64%, #4599DB 102.4%, #AADAFF 102.4%)',
		backgroundSize: '200% auto',
		backgroundClip: 'text',
		WebkitBackgroundClip: 'text',
		WebkitTextFillColor: 'transparent',
